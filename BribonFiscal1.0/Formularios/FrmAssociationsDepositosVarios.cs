...
{
    public partial class FrmAssociationsDepositosVarios : Form
    {

        // lista de seleccionados
        List<String> uuidLista = new List<String>();

        public FrmAssociationsDepositosVarios()
        {
            InitializeComponent();
        }

        private void FrmAssociationsDepositosVarios_Load(object sender, EventArgs e)
        {
        ...
        {
            ActCFDIAux(this.textBox2.Text.ToString(), this.dateTimePicker3.Value, this.dateTimePicker4.Value);
        }
        private void ActCFDIAux(string rfcemisor, DateTime fechaini, DateTime fechafin)
        {
            String query = $"call bancos_auxiliarcfdi_depositosvarios('{rfcemisor}','{fechaini.ToString("yyyy-MM-dd")}','{fechafin.ToString("yyyy-MM-dd")}');";
            ...
            else
            {
                ...
                this.label12.Text = $"Total filas: {dataGridView3.Rows.Count.ToString()}";
            }
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                this.label11.Text = $"Total filas: {dataGridView1.Rows.Count.ToString()}";
